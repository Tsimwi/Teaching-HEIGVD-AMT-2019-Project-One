...
class CharactersServletTest {
    ...
    private CharactersServlet servlet;
    ...
    void setup() {
        ...
        servlet = new CharactersServlet();
        servlet.characterManager = characterManager;
        characters = new ArrayList<>();
        when(request.getParameterMap()).thenReturn(map);
        when(request.getRequestDispatcher("/WEB-INF/pages/characters.jsp")).thenReturn(requestDispatcher);
